...
---
<!-- Modified by TechnologyKSA for Abdo Code — origin: anthropics/knowledge-work-plugins@1f517b9de47e skills/create-an-asset/SKILL.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
# Create an Asset
...
"Abdo Code retrieves the Nike contract PDF and extracts the performance
obligations: minimum $50M revenue, 12% margin requirement, quarterly
reporting deadline..."

Step 3: Data Query
"Abdo Code formulates a query and sends it to Workato DataGenie:
'Get Q4 2025 revenue and gross margin for Nike brand from Snowflake'..."

Step 4: Results & Synthesis
"Snowflake returns the data. Abdo Code compares actuals vs. obligations:
Revenue $52.3M ✓ (exceeded by $2.3M)
Margin 11.2% ⚠️ (0.8% below threshold)..."

Step 5: Insight Delivery
"Abdo Code synthesizes findings into an executive summary with
...
- Components: Abdo Code, Workato DataGenie, Snowflake, PDF contracts

**Output structure:**
```
[Interactive canvas with 5 nodes]
Human → Abdo Code → PDF Contracts → Workato → Snowflake
         ↓
...
| ai | 🤖 or brain SVG | Abdo Code, AI Agent |
