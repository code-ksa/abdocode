...
- Includes Abdo Code attribution in commit message
...
This plugin is included in the Abdo Code repository. The commands are automatically available when using Abdo Code.

## Best Practices

### Using `/commit`
- Review the staged changes before committing
- Let Abdo Code analyze your changes and match your repo's commit style
...
- Abdo Code will analyze the full branch history for the PR description
...
- **Let Abdo Code draft messages**: The commit message analysis learns from your repo's style
