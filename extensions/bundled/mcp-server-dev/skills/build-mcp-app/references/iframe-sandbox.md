...
MCP-app widgets run inside a sandboxed `<iframe>` in the host (Abdo Code Desktop,
...
The iframe has its own console. In Abdo Code Desktop, open DevTools (View → Toggle
