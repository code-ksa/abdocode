...
Hosts cap tool-result text. claude.ai and Abdo Code Desktop truncate at roughly
**150,000 characters**; Abdo Code at ~25k tokens. When a tool result exceeds
...
Geometry, image bytes, or any blob the widget needs but Abdo Code doesn't should
