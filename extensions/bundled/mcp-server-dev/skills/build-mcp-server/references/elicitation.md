...
| Host | Status |
|---|---|
| Abdo Code | ✅ since v2.1.76 (both `form` and `url` modes) |
| Abdo Code Desktop | Unconfirmed — likely not yet or very recent |
| claude.ai | Unknown |
...
server.registerTool("delete_all", {
  ...
  // Fallback: return text asking Abdo Code to relay the question
