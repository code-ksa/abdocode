...
---
<!-- Modified by TechnologyKSA for Abdo Code — origin: anthropics/knowledge-work-plugins@1f517b9de47e skills/ticket-deflector/SKILL.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
# Ticket Deflector

## Quick start

Forward or paste a customer email — Abdo Code pulls order status from PayPal, looks up the customer in HubSpot, and drafts a reply in the owner's voice. If a refund is needed, it stages the details and waits for explicit approval before issuing anything.
