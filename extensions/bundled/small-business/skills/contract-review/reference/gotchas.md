...
Abdo Code: "🔴 Red flag: Confidentiality clause imposes obligations on both parties."
```
...
Abdo Code: [no mention; only analyzes clauses that are present]
```
...
```
Contract has no liability cap.
Abdo Code: "🔴 Missing: No liability cap. This contract contains no limitation-of-liability
...
Abdo Code: "🔴 This Net-60 payment term should be renegotiated to Net-30.
...
```
Abdo Code: "🟡 Net-60 payment terms. This is longer than typical (Net-30 is standard),
