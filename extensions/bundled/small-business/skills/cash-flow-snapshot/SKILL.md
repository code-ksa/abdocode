...
---
<!-- Modified by TechnologyKSA for Abdo Code — origin: anthropics/knowledge-work-plugins@1f517b9de47e skills/cash-flow-snapshot/SKILL.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
# Cash Flow Snapshot
...
Abdo Code pulls AR/AP and fixed costs from connected sources, calculates expected
