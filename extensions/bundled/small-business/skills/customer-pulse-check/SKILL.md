...
---
<!-- Modified by example for Abdo Code — origin: anthropics/knowledge-work-plugins@1f517b9de47e skills/customer-pulse-check/SKILL.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
