...
If Abdo Code embeds them as markdown images (`![](design.canva.ai/...)`), they
...
**Why it matters:** When Abdo Code lists each design as a separate block
...
Abdo Code guesses a template by name and generates with the wrong one, the owner
