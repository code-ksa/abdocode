...
✗ **Bad:** Abdo Code reaches Phase 6, opens DocuSign in Chrome, and then asks mid-flow:
...
✗ **Bad:** The user has a 3-section job post on file. Abdo Code produces a 7-section
...
✗ **Bad:** No salary range was provided, so Abdo Code writes "$120,000–$150,000 DOE"
