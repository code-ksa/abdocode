...
## Phase 1 — What Abdo Code extracts
...
Abdo Code confirms and asks exactly one question:
...
2. **About the company** — 3–4 sentences (Abdo Code asks or infers from context).
