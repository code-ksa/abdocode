...
---
<!-- Modified by TechnologyKSA for Abdo Code — origin: anthropics/knowledge-work-plugins@1f517b9de47e skills/customer-pulse/SKILL.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
# Customer Pulse
...
Abdo Code pulls disputes, tickets, email threads, and Intercom conversations for the last 30 days, groups them into 3–5 themes with verbatim evidence, and delivers a "do these 3 things this week" action list.
