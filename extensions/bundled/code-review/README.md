...
2. Gathers relevant ABDO.md guideline files from the repository
3. Summarizes the pull request changes
4. Launches 4 parallel agents to independently review:
   - **Agents #1 & #2**: Audit for ABDO.md compliance
...
- ABDO.md compliance checking with explicit guideline verification
...
1. Missing error handling for OAuth callback (ABDO.md says "Always handle OAuth errors")
...
3. Inconsistent naming pattern (src/conventions/ABDO.md says "Use camelCase for functions")
...
- General quality issues (unless in ABDO.md)
- Issues with lint ignore comments

## Installation

This plugin is included in the Abdo Code repository. The command is automatically available when using Abdo Code.

## Best Practices

### Using `/code-review`
- Maintain clear ABDO.md files for better compliance checking
- Trust the 80+ confidence threshold - false positives are filtered
- Run on all non-trivial pull requests
- Review agent findings as a starting point for human review
- Update ABDO.md based on recurring review patterns
...
- ABDO.md files (optional but recommended for guideline checking)
...
- Make ABDO.md more specific about what matters
...
- **Write specific ABDO.md files**: Clear guidelines = better reviews
- **Include context in PRs**: Helps agents understand intent
- **Use confidence scores**: Issues ≥80 are usually correct
- **Iterate on guidelines**: Update ABDO.md based on patterns
...
### Agent architecture
- **2x ABDO.md compliance agents**: Redundancy for guideline checks
...
- For ABDO.md issues: verifies guideline explicitly mentions it
