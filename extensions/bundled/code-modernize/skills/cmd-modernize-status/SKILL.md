---
name: cmd-modernize-status
description: Where am I in the modernization workflow — artifact inventory, staleness, secrets hygiene, next step
---
<!-- Modified by TechnologyKSA for Abdo Code — origin: anthropics/claude-plugins-official@85cce0381e78 commands/modernize-status.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
...
| reimagine | `modernized/$1-reimagined/` — note per-service acceptance tests and the `ABDO.md` handoff (reimagine's completion markers; it does NOT write `TRANSFORMATION_NOTES.md`) |
