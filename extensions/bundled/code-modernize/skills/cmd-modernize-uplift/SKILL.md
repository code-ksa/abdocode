...
---
<!-- Modified by TechnologyKSA for Abdo Code — origin: anthropics/claude-plugins-official@85cce0381e78 commands/modernize-uplift.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
...
```
Workflow({
  scriptPath: "${extension}/workflows/uplift-deltas.js",
...
```
Workflow({
  scriptPath: "${extension}/workflows/uplift-migrate.js",
