---
name: cmd-modernize-reimagine
description: Multi-agent greenfield rebuild — extract specs from legacy, design AI-native, scaffold & validate with HITL
---
<!-- Modified by TechnologyKSA for Abdo Code — origin: anthropics/claude-plugins-official@85cce0381e78 commands/modernize-reimagine.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
The first token of `(the user's request)` is the system dir (`$1`); **everything
...
```
Workflow({
  scriptPath: "${extension}/workflows/reimagine-scaffold.js",
...
Write `modernized/$1-reimagined/ABDO.md` — the persistent context file for
