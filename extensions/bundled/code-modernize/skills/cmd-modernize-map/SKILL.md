---
name: cmd-modernize-map
description: Dependency & topology mapping — call graphs, data lineage, batch flows, rendered as navigable diagrams
---
<!-- Modified by TechnologyKSA for Abdo Code — origin: anthropics/claude-plugins-official@85cce0381e78 commands/modernize-map.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
...
```bash
python3 - "${extension}/assets/topology-viewer.html" analysis/$1 <<'EOF'
import json, sys
...
`${extension}` was not substituted — report that rather than
