---
name: cmd-modernize-brief
description: Generate a phased Modernization Brief — the approved plan that transformation agents will execute against
---
<!-- Modified by TechnologyKSA for Abdo Code — origin: anthropics/claude-plugins-official@85cce0381e78 commands/modernize-brief.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
