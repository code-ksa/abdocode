---
name: cmd-modernize-assess
description: Full discovery & portfolio analysis of a legacy system — inventory, complexity, debt, relative scale
---
<!-- Modified by TechnologyKSA for Abdo Code — origin: anthropics/claude-plugins-official@85cce0381e78 commands/modernize-assess.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
**Mode select.** If `(the user's request)` starts with `--portfolio`, run **Portfolio
...
```
Workflow({
  scriptPath: "${extension}/workflows/portfolio-assess.js",
