---
name: cmd-modernize-transform
description: Transform one legacy module to the target stack — idiomatic rewrite with behavior-equivalence tests
---
<!-- Modified by TechnologyKSA for Abdo Code — origin: anthropics/claude-plugins-official@85cce0381e78 commands/modernize-transform.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
