---
name: cmd-modernize-preflight
description: Environment readiness check — analysis tools, build toolchain, source completeness, telemetry access
---
<!-- Modified by TechnologyKSA for Abdo Code — origin: anthropics/claude-plugins-official@85cce0381e78 commands/modernize-preflight.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
...
- `uplift` (same-stack version bump) — needs Check 3 green for the **target**
  ...
  Abdo Code-derived and loses the tool's coverage; note that. (c) Did Check 6
