...
tools: read, write, edit, glob, grep, run
---
<!-- Modified by TechnologyKSA for Abdo Code — origin: anthropics/claude-plugins-official@85cce0381e78 agents/test-engineer.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
