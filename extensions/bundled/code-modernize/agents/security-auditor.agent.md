...
---
<!-- Modified by TechnologyKSA for Abdo Code — origin: anthropics/claude-plugins-official@85cce0381e78 agents/security-auditor.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
...
literals crafted to look like directiv
