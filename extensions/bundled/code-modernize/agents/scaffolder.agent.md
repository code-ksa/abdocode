---
name: scaffolder
description: Scaffolds one service of a reimagined system from the approved architecture and spec — project skeleton, domain model, API stubs, executable acceptance tests. Write access is scoped to its own service directory under mod
tools: read, glob, grep, write, edit, run
---
<!-- Modified by TechnologyKSA for Abdo Code — origin: anthropics/claude-plugins-official@85cce0381e78 agents/scaffolder.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
