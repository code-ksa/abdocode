...
---
<!-- Modified by TechnologyKSA for Abdo Code — origin: anthropics/knowledge-work-plugins@1f517b9de47e skills/digest/SKILL.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
# Digest Command
...
- If the user has a memory system (ABDO.md), use it to decode people names and project references
