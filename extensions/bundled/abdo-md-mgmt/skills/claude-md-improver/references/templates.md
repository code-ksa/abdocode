...
Describe the project structure so Abdo Code understands where things live.
...
List important files that Abdo Code should know about.
...
4. **Be useful**: Would this help a new Abdo Code session understand the project?
