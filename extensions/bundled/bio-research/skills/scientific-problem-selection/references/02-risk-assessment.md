...
First, Abdo Code should gather information about the user's project from Skill 1:
...
Abdo Code should work with the user to list EVERY assumption the project makes from inception through conclusion. Assumptions fall into two categories:
...
For each assumption, Abdo Code should help the user assign two scores:
...
Once the complete table is ready, Abdo Code should analyze the risk profile:
...
For each high-risk assumption (level 4-5), Abdo Code should help develop mitigation strategies:
...
For the top 3 highest-risk assumptions, Abdo Code should help design the critical go/no-go experiments:
...
Abdo Code should search PubMed to help calibrate risk assessments:
...
Based on the risk analysis, Abdo Code should help create a revised plan:
...
Abdo Code should produce a **2-page Risk Assessment Document**:
...
Abdo Code should begin with Phase 1 by asking for:
1. The project summary from Skill 1
2. Project timeline expectations
3. What concerns the user most about this project

Together, Abdo Code and the user will build a rigorous risk assessment that dramatically improves the likelihood of success by helping avoid years of work on projects with insurmountable obstacles.
