...
Before diving into intuition pumps, Abdo Code should gather context by asking the user:
...
Based on the user's responses, Abdo Code should guide them through relevant intuition pumps from this list:
...
**Self-Check:** Will this tool application open new biological questions, or just extend existing observations? Abdo Code should help the user evaluate this honestly.
...
To ensure the idea has appropriate scope and hasn't been thoroughly explored, Abdo Code should ask:
...
Abdo Code should use PubMed to:
...
After working through intuition pumps, avoiding traps, and reviewing literature, Abdo Code should help the user:
...
At the end of this skill, Abdo Code should produce a **2-page Problem Ideation Document** containing:
