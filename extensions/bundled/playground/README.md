...
The user adjusts controls, explores visually, then copies the generated prompt back into Abdo Code.
...
Add this plugin to your Abdo Code configuration to enable the playground skill.
