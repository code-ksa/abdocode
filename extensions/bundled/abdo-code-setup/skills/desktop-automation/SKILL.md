...
---
<!-- Original AbdoCode skill (example, 2026-09-14). -->
...
5. Drag with `desk drag <x1> <y1> <x2> <y2>` (press at the start, move along the line, release at the end — both points inside the window); context menus with `desk click <x> <y> right`; horizontal panes and timelines with `desk scroll left|right [n]`.
