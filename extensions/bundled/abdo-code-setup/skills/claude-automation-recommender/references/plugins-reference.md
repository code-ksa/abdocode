...
|--------|----------|--------------|
| **plugin-dev** | Building Abdo Code plugins | Skills for creating skills, hooks, commands, agents |
...
- User wants to install Abdo Code automations from Abdo Code's official repository or another shared marketplace
- User needs multiple related capabilities
- Team wants standardized workflows
- First-time Abdo Code setup