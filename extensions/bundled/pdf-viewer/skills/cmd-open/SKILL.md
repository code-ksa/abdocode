...
---
<!-- Modified by TechnologyKSA for Abdo Code — origin: anthropics/knowledge-work-plugins@1f517b9de47e commands/open.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
...
the viewer — use Abdo Code's native Read tool on the PDF path instead.
