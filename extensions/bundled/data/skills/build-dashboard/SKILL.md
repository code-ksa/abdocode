...
---
<!-- Modified by TechnologyKSA for Abdo Code — origin: anthropics/knowledge-work-plugins@1f517b9de47e skills/build-dashboard/SKILL.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
...
<head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/chart.js@4.5.1" integrity="sha384-<digest>" crossorigin="anonymous"></script>
    <script src="https://cdn.jsdelivr.net/npm/chartjs-adapter-date-fns@3.0.0" integrity="sha384-<digest>" crossorigin="anonymous"></script>
    <style>
