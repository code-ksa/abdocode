...
---
<!-- Modified by TechnologyKSA for Abdo Code — origin: anthropics/knowledge-work-plugins@1f517b9de47e skills/write-query/SKILL.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
...
- If you know the table names, include them -- otherwise Abdo Code will help you find them
