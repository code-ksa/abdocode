...
---
<!-- Modified by TechnologyKSA for Abdo Code — origin: anthropics/knowledge-work-plugins@1f517b9de47e skills/create-viz/SKILL.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
...
- If you want interactive charts (hover, zoom, filter), mention "interactive" and Abdo Code will use plotly
