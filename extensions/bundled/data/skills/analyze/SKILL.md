...
---
<!-- Modified by TechnologyKSA for Abdo Code — origin: anthropics/knowledge-work-plugins@1f517b9de47e skills/analyze/SKILL.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
...
- For complex questions, Abdo Code may break them into multiple queries
- Results are always validated before presentation -- if something looks off, Abdo Code will flag it
