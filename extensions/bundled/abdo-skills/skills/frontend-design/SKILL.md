...
---
<!-- Modified by example for Abdo Code — origin: anthropics/skills@41bbe19d1a1a skills/frontend-design/SKILL.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
# Frontend Design
