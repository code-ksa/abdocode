...
- **Stop**: When Abdo Code wants to stop working
...
The message body is what Abdo Code sees when the rule triggers.
...
2. Try to trigger it:
   - Ask Abdo Code to run `rm -rf /tmp/test`
...
For more examples, check the `${extension}/examples/` directory.
