...
---
<!-- Modified by TechnologyKSA for Abdo Code — origin: anthropics/claude-plugins-official@85cce0381e78 commands/hookify.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
...
**If (the user's request) is provided:**
- User has given specific instructions: `(the user's request)`
...
**If (the user's request) is empty:**
...
Use the `delegate` tool to launch conversation-analyzer agent:
```
{
  "subagent_type": "general-purpose",
  "description": "Analyze conversation for unwanted behaviors",
  "prompt": "You are analyzing a Abdo Code conversation to find behaviors the user wants to prevent.
...
2. Corrections or reversions (user fixing Abdo Code's actions)
...
{Message to show Abdo Code when rule triggers}
```
...
Use the current working directory (where Abdo Code was started) as the base path.
...
Use the plan board to track your progress through the steps.
