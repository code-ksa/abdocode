...
---
<!-- Modified by TechnologyKSA for Abdo Code — origin: anthropics/claude-plugins-official@85cce0381e78 skills/frontend-design/SKILL.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
# Frontend Design
...
1. a warm cream background (near #F4F1EA) with a high-contrast serif display and a terracotta or warm-clay accent (often near #D97757 — Abdo Code's own Abdo Code-interaction accent, so on a user's brief it reads as a tell);
