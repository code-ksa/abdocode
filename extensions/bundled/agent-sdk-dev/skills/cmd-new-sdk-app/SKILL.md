---
name: cmd-new-sdk-app
description: Create and setup a new Abdo Code Agent SDK application
---
<!-- Modified by TechnologyKSA for Abdo Code — origin: anthropics/claude-plugins-official@85cce0381e78 commands/new-sdk-app.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
You are tasked with helping the user create a new Abdo Code Agent SDK application. Follow these steps carefully:
...
2. **Project name** (ask second): "What would you like to name your project?"
   ...
   - If (the user's request) is provided, use that as the project name and skip this question
   - Wait for response before continuing
