...
A comprehensive plugin for creating and verifying Abdo Code Agent SDK applications in Python and TypeScript.
...
Interactive command that guides you through creating a new Abdo Code Agent SDK application.
...
This plugin is included in the Abdo Code repository. To use it:

1. Ensure Abdo Code is installed
