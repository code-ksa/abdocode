...
session that encourage Abdo Code to:
...
session. This context instructs Abdo Code to provide brief educational explanations
...
ABDO.md, but it is more flexible and allows for distribution through plugins.
