...
```
You: /write-spec
Abdo Code: What feature or problem are you speccing out?
You: We need to add SSO support for enterprise customers
Abdo Code: [Asks about target users, constraints, success metrics]
Abdo Code: [Generates full PRD with problem statement, user stories, requirements, success metrics, open questions]
```
...
Abdo Code: What type of update? (weekly, monthly, launch, ad-hoc)
You: Weekly update for the exec team
Abdo Code: [Pulls context from project management tool, chat, and docs]
Abdo Code: [Generates executive summary with progress, decisions, risks, and next milestones]
```
...
Abdo Code: What research do you want to synthesize? You can paste interview notes, upload files, or I can pull from connected sources.
You: [Pastes 8 interview transcripts]
Abdo Code: [Identifies themes, patterns, and insights across interviews]
Abdo Code: [Generates synthesis with key findings, personas, opportunity areas, and evidence]
```
...
Abdo Code: Before we jump to AI search — what problem are your users hitting with search today?
You: They can't find things. Support tickets about "can't find X" are our #2 category.
Abdo Code: That's a discovery problem, not necessarily a search technology problem. Let me push on this...
Abdo Code: [Explores whether the issue is search quality, information architecture, or content discoverability]
Abdo Code: [Generates 5 distinct approaches ranging from better taxonomy to AI search to guided navigation]
Abdo Code: [Challenges assumptions, suggests cheapest experiment to test the riskiest one]
```
...
Abdo Code: Which competitor(s) or feature area do you want to analyze?
You: Compare our onboarding flow to [competitor A] and [competitor B]
Abdo Code: [Researches competitor onboarding approaches]
Abdo Code: [Generates brief with feature comparison, strengths/weaknesses, and strategic implications]
```
