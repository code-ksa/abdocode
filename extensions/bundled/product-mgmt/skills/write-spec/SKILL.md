...
---
<!-- Modified by TechnologyKSA for Abdo Code — origin: anthropics/knowledge-work-plugins@1f517b9de47e skills/write-spec/SKILL.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
# Write Spec
