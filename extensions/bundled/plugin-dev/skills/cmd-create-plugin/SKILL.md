---
name: cmd-create-plugin
description: Guided end-to-end plugin creation workflow with component design, implementation, and validation
---
<!-- Modified by TechnologyKSA for Abdo Code — origin: anthropics/claude-plugins-official@85cce0381e78 commands/create-plugin.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
# Plugin Creation Workflow

Guide the user through creating a complete, high-quality Abdo Code plugin from initial concept to tested implementation. Follow a systematic approach: understand requirements, design components, clarify details, implement following best practices, validate, and test.
...
- **Use the plan board**: Track all progress throughout all phases

**Initial request:** (the user's request)
...
2. For each skill:
   ...
   - For user-invoked skills (slash commands): include `description`, `argument-hint`, and `allowed-tools` frontmatter; write instructions FOR Abdo Code (not TO user)
...
2. For each command:
   ...
   - Write instructions FOR Abdo Code (not TO user)
...
2. Create .mcp.json configuration with:
   ...
   - Command and args (with ${extension})
...
**Goal**: Test that plugin works correctly in Abdo Code
...
- **Use the plan board** to track progress at every phase
...
- **Apply best practices**:
  ...
  - Skill instructions written FOR Abdo Code (not TO user)
  - Strong trigger phrases
  - ${extension} for portability
