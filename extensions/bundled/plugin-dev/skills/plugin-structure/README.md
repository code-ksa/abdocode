...
Comprehensive guidance on Abdo Code plugin architecture, directory layout, and best practices.
...
- Portable path references with `${extension}`
...
Abdo Code loads references and examples only as needed based on the task.
