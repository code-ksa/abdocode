...
```json
{
  "mcpServers": {
    "kubernetes": {
      "command": "node",
      "args": ["${extension}/servers/kubernetes-mcp/index.js"],
      "env": {
    ...
    "terraform": {
      "command": "python",
      "args": ["${extension}/servers/terraform-mcp/main.py"],
      "env": {
    ...
    "github-actions": {
      "command": "node",
      "args": ["${extension}/servers/github-actions-mcp/server.js"],
      "env": {
...
\`\`\`javascript
const { DatadogClient } = require('${extension}/lib/integrations/datadog')
...
\`\`\`javascript
const { SlackClient } = require('${extension}/lib/integrations/slack')
...
\`\`\`bash
bash ${extension}/skills/kubernetes-ops/scripts/validate-manifest.sh deployment.yaml
\`\`\`
```
  ...
  "PreToolUse": [
    {
      ...
      "hooks": [
        {
          "type": "command",
          "command": "bash ${extension}/hooks/scripts/security/scan-secrets.sh",
          "timeout": 30
        }
      ]
    },
  ...
  "PostToolUse": [
    {
      ...
      "hooks": [
        {
          "type": "command",
          "command": "bash ${extension}/hooks/scripts/workflow/update-status.sh",
          "timeout": 15
        }
      ]
    }
  ...
  "Stop": [
    {
      ...
      "hooks": [
        {
          "type": "command",
          "command": "bash ${extension}/hooks/scripts/quality/check-config.sh",
          "timeout": 45
        },
        {
          "type": "command",
          "command": "bash ${extension}/hooks/scripts/workflow/notify-team.sh",
          "timeout": 30
        }
      ]
    }
  ...
  "SessionStart": [
    {
      ...
      "hooks": [
        {
          "type": "command",
          "command": "bash ${extension}/hooks/scripts/security/validate-permissions.sh",
          "timeout": 20
        }
      ]
    }
