...
Use this template to generate agents using Abdo Code with the agent creation system prompt.
...
Send this to Abdo Code (with the agent-creation-system-prompt loaded):
...
### Step 3: Abdo Code Returns JSON

Abdo Code will return:
...
Tell Abdo Code when the agent should activate:
...
- **Comprehensive**: Abdo Code includes edge cases and quality checks
