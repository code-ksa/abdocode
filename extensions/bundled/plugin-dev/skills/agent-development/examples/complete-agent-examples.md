...
3. Check adherence to project best practices and coding standards from ABDO.md
...
5. **Best Practices**:
   - Follow project-specific standards from ABDO.md
...
- Missing context (no ABDO.md): Apply general best practices
