...
---
<!-- Modified by TechnologyKSA for Abdo Code — origin: anthropics/claude-plugins-official@85cce0381e78 skills/plugin-settings/SKILL.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
# Plugin Settings Pattern for Abdo Code Plugins
...
- Prompts to feed back to Abdo Code
...
5. Remind user to restart Abdo Code for hooks to recognize changes
```
...
After creating or editing, restart Abdo Code for changes to take effect.
```
...
**Important:** Settings changes require Abdo Code restart.
...
7. Remind users that changes require Abdo Code restart
