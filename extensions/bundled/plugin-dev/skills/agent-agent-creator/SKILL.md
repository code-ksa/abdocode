...
---
<!-- Modified by TechnologyKSA for Abdo Code — origin: anthropics/claude-plugins-official@85cce0381e78 agents/agent-creator.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
...
This agent automates agent creation using the proven patterns from Abdo Code's internal implementation, making it easy for users to create high-quality autonomous agents.
