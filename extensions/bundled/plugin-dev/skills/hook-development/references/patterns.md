...
This reference provides common, proven patterns for implementing Abdo Code hooks. Use these patterns as starting points for typical hook use cases.
  ...
  "Notification": [
    {
      ...
      "hooks": [
        {
          "type": "command",
          "command": "bash ${extension}/scripts/log-notification.sh"
        }
      ]
    }
  ]
  ...
  "PostToolUse": [
    {
      ...
      "hooks": [
        {
          "type": "command",
          "command": "bash ${extension}/scripts/check-quality.sh"
        }
      ]
    }
  ]
...
**Note:** Must restart Abdo Code after creating/removing flag files for hooks to recognize changes.
