...
**Important:** All examples below are written as instructions FOR Abdo Code (agent consumption), not messages TO users. Commands tell Abdo Code what to do, not tell users what will happen.

## Example 1: Code Review Command

**File:** `.abdo/commands/review.md`
...
**File:** `.abdo/commands/security-review.md`
...
**File:** `.abdo/commands/test-file.md`
...
**File:** `.abdo/commands/document.md`
...
**File:** `.abdo/commands/git-status.md`
...
**File:** `.abdo/commands/compare-files.md`
...
**File:** `.abdo/commands/quick-fix.md`
...
**File:** `.abdo/commands/research.md`
