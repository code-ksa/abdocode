...
**Purpose:** Specify which Abdo Code model executes the command
...
- Abdo Code can invoke programmatically
...
**Best practices:**
- Use sparingly (limits Abdo Code's autonomy)
...
**Invalid model name:**
```yaml
model: gpt4  # ❌ Not a valid Abdo Code model
```
