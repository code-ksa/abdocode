...
Comprehensive guidance on creating Abdo Code slash commands, including file format, frontmatter options, dynamic arguments, and best practices.
...
- Plugin-specific features (${extension}, plugin patterns)
...
- **plugin-features-reference.md**: Plugin-specific command features
  - Plugin command discovery and organization
  - ${extension} environment variable usage
  - Plugin command patterns (configuration, template, multi-script)
...
Abdo Code activates this skill when users:
...
Abdo Code loads references and examples as needed based on task.
...
- **Project**: `.abdo/commands/` (shared with team)
- **Personal**: `~/.abdo/commands/` (your commands)
...
- ✓ Plugin command patterns (${extension}, discovery, organization)
...
6. Test examples work with current Abdo Code
