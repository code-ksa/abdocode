---
name: cmd-maker-setup
description: Onboard a Code-with-Abdo Code Makers Cardputer — fetch the build-with-claude repo, flash firmware, and install the Abdo Code Buddy apps.
---
<!-- Modified by TechnologyKSA for Abdo Code — origin: anthropics/claude-plugins-official@85cce0381e78 commands/maker-setup.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
...
3. When done, tell the user how to launch Abdo Code Buddy and ask what they want to build next (see the `cardputer-buddy` skill for iterating).
