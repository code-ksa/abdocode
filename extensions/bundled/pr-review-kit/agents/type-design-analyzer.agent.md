...
description: Use this agent when you need expert analysis of type design in your codebase. Specifically use it (1) when introducing a new type to ensure it follows best practices for encapsulation and invariant expression, (2) during
tools: read, list, glob, grep
---
<!-- Modified by TechnologyKSA for Abdo Code — origin: anthropics/claude-plugins-official@85cce0381e78 agents/type-design-analyzer.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
...
- Inconsistent enforcement across mutatio
