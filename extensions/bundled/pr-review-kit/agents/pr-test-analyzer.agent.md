...
description: Use this agent when you need to review a pull request for test coverage quality and completeness. This agent should be invoked after a PR is created or updated to ensure tests adequately cover new functionality and edge
tools: read, list, glob, grep
---
<!-- Modified by TechnologyKSA for Abdo Code — origin: anthropics/claude-plugins-official@85cce0381e78 agents/pr-test-analyzer.md (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->
...
- Consider the project's testing standards from ABDO.md if available
