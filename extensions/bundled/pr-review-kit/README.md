...
Simply ask questions that match an agent's focus area, and Abdo Code will automatically trigger the appropriate agent:
...
Abdo Code may proactively use these agents based on context:
...
- User agents: `~/.abdo/agents/`
- Project agents: `.abdo/agents/` in claude-cli-internal
