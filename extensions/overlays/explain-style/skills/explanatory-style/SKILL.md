...
---
<!-- Original Abdo Code skill (example, 2026-09-06). The origin plugin implemented this style with hooks, which Abdo Code does not run by design; the style is expressed here as instructions. -->
