...
const changeNote = (origin, rel) => `<!-- Modified by example for Abdo Code — origin: anthropics/${origin.repo}@${origin.sha.slice(0, 12)} ${rel} (Apache-2.0). Names, paths and tool references adapted; see NOTICE.md. -->`
