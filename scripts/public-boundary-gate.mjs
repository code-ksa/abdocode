...
const roots = ["packages", "architecture", existsSync("public-docs") ? "public-docs" : "docs", "extensions", "scripts", "legal", "README.md", "AGENTS.md", "llms.txt", "package.json"]
...
const CREDIT_FILES = new Set(["README.md", "AGENTS.md", "llms.txt", "package.json"])
