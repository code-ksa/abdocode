...
- Run `bun test` in the package you touched and `bun scripts/public-boundary-gate.mjs` at the root. The gate refuses private paths, accounts and product names that must not ship.
