...
/** ما يقطع الهدف: حروفُ جرٍّ وظروفُ مكانٍ وعطفٌ وحشوٌ زمنيّ ولهجيّ. تُصدَّر كي تقتطع طبقةُ العمليّات هدفَها بالقائمة نفسها — لا قائمتان تتباعدان. */
export const TARGET_STOPS = set(["في", "من", "على", "الى", "إلى", "عند", "جوه", "جوا", "داخل", "بره", "برا", "فوق", "تحت", "و", "او", "أو", "ثم", "بعدين", "عشان", "علشان", "لان", "لأن", "اللي", "الي", "ده", "دي", "هذا", "هذه", "هاد", "هاي", "ذا", "هال", "ال", "لو", "سمحت", "يا", "بس", "طيب", "تمام", "خالص", "دلوقتي", "دلوقت", "الحين", "هلق", "هلا", "هسه", "دابا", "زين", "بقى", "بقا", "كده", "كدا", "الان", "الآن", "شكو", "بيه", "in", "into", "at", "on", "under", "inside", "from", "to", "and", "then", "please", "now", "the", "a", "an", "my", "our", "your", "this", "that"])
const STOPS = TARGET_STOPS
