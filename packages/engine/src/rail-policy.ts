...
const PROFILES: Record<RailTier, Omit<RailProfile, "reason">> = {
  ...
  // الرفيع: عنانٌ طويل (100 جولة في الحقبة — أمر 09-16؛ كان 32 بأمر 09-02 فكان الدورُ يقف مبكّراً في المشاريع الكبيرة)
  // وحقنٌ من الوعي المقيس فقط (خريطة باردة، حقائق، دفتر الدور) بلا مواعظَ ولا نثرٍ ولا خلاصاتٍ ولا موجزاتٍ
  // دلاليّة/عامّة (أمر 09-06). الأمن كاملٌ خارج هذا الملف. السقفُ مربوطٌ بحدّ الحلقة MAX_TEXT_AGENT_ROUNDS باختبار.
  thin: { tier: "thin", coldMap: true, awarenessBrief: true, factRecall: true, errorPlaybooks: false, sprintPlanRequired: false, maxRounds: 100, qualityGuards: false, coaching: false, orientationProse: false, sessionSummary: false, semanticBrief: false, generalAwareness: false },
}
