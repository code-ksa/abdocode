...
export type SurfaceAction =
  ...
  // ن5 (09-16) — رجوعٌ/تقدّمٌ في تاريخ التبويب: تنقّلٌ كـnavigate (شبكة) وإن كان الرابطُ من التاريخ لا من النموذج.
...
const describe = (a: SurfaceAction): string => {
  switch (a.kind) {
    ...
    case "history": return a.direction === "back" ? "ارجع صفحةً" : "تقدّم صفحةً"
  }
}
