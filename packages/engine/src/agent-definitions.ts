...
// 09-16: القرّاءُ الثلاثة (orient/planner/reviewer) يعلنون `team` — أثرُها قراءةٌ فيبقون قراءةً-فقط،
// والحارسُ يسمح بها للقارئ تحت سقف العمق لقرّاءٍ فقط؛ recaller عدسةٌ ضيّقة لا توازي.
// ---------------------------------------------------------------------------
...
tools: project-orient, recall, read, list, glob, grep, git, docs, team
---
...
tools: read, list, glob, grep, docs, recall, team
---
...
tools: read, list, glob, grep, git, recall, team
---
