...
describe("هـ2 — سلّمُ الأوضاع (أمر المالك 2026-09-07)", () => {
  ...
  test("احتواءُ الطفل: لا يفوّض ولا يفرّق فريقاً ولا يمسّ لوحَ الخطّة، وسقفُ أدواته يمنع ما لم يعلنه", () => {
    ...
    expect(childToolRefusal(planner, TEAM_TOOL, 1)).toContain("لا يفوّض")
