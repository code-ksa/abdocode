...
const ICONS = {
  ...
  language:'M4 15 7.5 6 11 15m-6-3h5m3-6h8m-4 0v2m3 0c-1 4-4 6-6 7m1-4c1 2 3 3 5 4',
...
export function mountSettingsSurfaces(api) {
  ...
  function renderPanels() {
    ...
    fact(p,t('Billing status','حالة الفوترة'),t('Unavailable locally','غير متاحة محليًا'));
    ...
    // خلفيّةُ متصفّح الوكيل (أمر المالك 09-13): الخفيفُ المملوك أو متصفّحُ المستخدم عبر الإضافة (كروم/إيدج/فايرفوكس) أو إيقاف — وتُبدَّل من الشات بكلمة browser.
    ...
    // م5 (أمر المالك 09-14): عبدو ريموت كونترول — الهاتفُ على الشبكة المحلّيّة يقترن برمزٍ ويرى الجلسةَ ويدفع إليها.
