//! BLUEPRINT_FACADE_V1 canonical=crates/abdo-kernel/src/effect.rs
...
pub const BLUEPRINT_ELEMENT: &str = "crates/abdo-kernel/src/state/effect.rs";
pub const CANONICAL_SOURCE: &str = "crates/abdo-kernel/src/effect.rs";
