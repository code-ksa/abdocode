...
export const TOOLS: readonly ToolSpec[] = [
  ...
  { name: "desk", effect: "outside-workspace", usage: "desk shot [screen] | desk windows | desk focus <عنوان> | desk click <x> <y> [right|double] | desk type <نص> | desk key <Enter|ctrl+s|…> | desk scroll <up|down> [عدد]", summary: "كومبيوتر-يوس على سطح مكتب المستخدم: لقطةٌ (للنافذة المركَّزة وحدها افتراضاً، و«desk shot screen» لكامل الشاشة) إلى نموذج الرؤية، النوافذُ وتركيزُها، نقرٌ وكتابةٌ ومفاتيحُ وتمرير — يحتاج تفعيل «تحكّم سطح المكتب» وموافقةً لكلّ فعل؛ **ولا إدخالَ بلا desk focus**: الإحداثيّاتُ من زاوية النافذة العليا اليسرى، والفعلُ يُلغى إن لم تكن هي المقدّمةَ لحظتَه", agentCallable: true, runner: "desktop" },
  ...
  { name: "browser", effect: "edit", usage: "browser [status | owned | extension | off]", summary: "خلفيّةُ متصفّح الوكيل من الشات: المتصفّحُ الخفيف المملوك (Edge عبر CDP)، أو إضافةُ المتصفّح الحقيقيّ (كروم/إيدج/فايرفوكس)، أو إيقاف — تُحفظ في الإعدادات", agentCallable: false, runner: "surface" },
